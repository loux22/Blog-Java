...
<h1><c:out value="${ user.getPseudo() }" /></h1>
<c:if test = "${!empty userArticle}"> 
...
<c:forEach items="${ userArticle }" var="userArticle" varStatus="status">
    <tr>
            <td scope="row"><c:out value="${ userArticle.getTitre() }" /></td>
            <td><c:out value="${ userArticle.getTexte() }" /></td>
            <td><c:out value="${ userArticle.getDescription() }" /></td>
            <td><c:out value="${ userArticle.getDate_article() }" /></td>
        </tr>
...
<c:if test = "${empty userArticle}"> 
<p><c:out value="${ user.getPseudo() }" /> n'a pas encore publié d'article</p>
</c:if> 
