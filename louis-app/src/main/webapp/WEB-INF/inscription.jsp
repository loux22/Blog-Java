...
<form action="" method="POST">
	...
	<input name="password_verif" type="password" placeholder="confirmer password">
	<button type="submit" name="addArticle">S'inscrire</button>
</form>
<% if(request.getAttribute("message") != null) {%>
    <div class="error"><%=request.getAttribute("message")%></div>
<%}%>	
<% if(request.getAttribute("alert") != null) {%>
    <div class="error"><%=request.getAttribute("alert")%></div>
<%}%>
