...
<thead>
        <tr>
            ...
            <th scope="col">voir Article creer</th>
        </tr>
    </thead>
    <tbody>
...
<c:forEach items="${ listUser }" var="listUser" varStatus="status">
    <tr>
            <td scope="row"><c:out value="${ listUser.getId() }" /></td>
            <td><c:out value="${ listUser.getPseudo() }" /></td>
            <td><a href="<%=application.getContextPath()%>/articleAuteur?auteur=${listUser.getId()}">Voir article créé</a></td>
        </tr>
